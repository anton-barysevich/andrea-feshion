...
const UpdatePayments = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                const res = await axios.get(link + 'payments/' + PaymentsId)
    ...
    const handleChange = (e) => {
        ...
        setPayments(prev => ({ ...prev, [e.target.name]: e.target.value }));
    }

    const handleClick = async e => {
        e.preventDefault()
        try {
            await axios.put(link + 'payments/update/' + PaymentsId, payments);

...
const UpdateDelivery = () => {
    ...
    const DeliveryId = location.pathname.split("/")[4]
    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                const res = await axios.get(link + 'delivery/' + DeliveryId)
    ...
    const handleClick = async e => {
        e.preventDefault()
        try{
            await axios.put(link + 'delivery/update/' + DeliveryId , delivery);
                ...
                <div id="Dashboard" class="tabcontent">
                    <div class="orders">
                        <div class="cardHeader">
                            <h2>Изменить способ доставки</h2>
                        ...
                        <div className="form">
                            ...
                            <input type="number" placeholder="Цена" name="price" value={price} onChange={handleChange}/>
                        </div>
                    </div>
                </div>
            </div>

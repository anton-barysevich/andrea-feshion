...
const AddSize = () => {
    ...
    const handleClick = async e => {
        e.preventDefault()
        try {
            await axios.post(link + 'sizes', sizes);
                ...
                <div id="Dashboard" class="tabcontent">
                    <div class="orders">
                        <div class="cardHeader">
                            <h2>Добавить Катеорию</h2>
                            <a class="tablinks btn" onClick={handleClick}>Добавить</a>
                        </div>
                        <div className="form">
                            <input type="text" placeholder="Размер" name="size" onChange={handleChange} />
                            <input type="text" placeholder="Охват Груди" name="grud" onChange={handleChange} />
                            <input type="text" placeholder="Охват Талии" name="talia" onChange={handleChange} />
                            <input type="text" placeholder="Охват Бёдер" name="bedra" onChange={handleChange} />
                            <input type="text" placeholder="Рост" name="rost" onChange={handleChange} />
                        </div>
                    </div>
                </div>
            </div>
